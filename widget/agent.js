    ...
    '<div id="eco-panel" class="eco-hidden" role="dialog" aria-label="Chat Eco Mangos">',
      ...
      '<div id="eco-booking-form">',
        ...
        '<div class="eco-extras">',
          ...
          '<div class="eco-extra-tip" id="eco-tip-mascota">Pet-friendly con condiciones: 1 perro de raza peque&ntilde;a (m&aacute;x. 10 kg) por carpa, previa coordinaci&oacute;n al reservar. Cuidados: con correa en &aacute;reas comunes y siempre supervisado. Prohibiciones: no sube a camas ni muebles; no ingresa a piscina, hidromasaje ni zonas de alimentos. El hu&eacute;sped responde por limpieza, desechos y da&ntilde;os de su mascota. <strong>Costo: S/ 50.</strong></div>',
